...
class InscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inscription" do
    assert_difference('Inscription.count') do
      post inscriptions_url, params: { inscription: { : @inscription., course_id: @inscription.course_id, date: @inscription.date, int: @inscription.int, user_id: @inscription.user_id } }
    end
  ...
  test "should update inscription" do
    patch inscription_url(@inscription), params: { inscription: { : @inscription., course_id: @inscription.course_id, date: @inscription.date, int: @inscription.int, user_id: @inscription.user_id } }
